...
# halfagiraf gold mark, top-right (logo fragment, scaled)
...
_ls = 9.0 / 577.0   # glyph height 9mm
svg.append(f'<g transform="translate({75.6 - 145 * _ls:.3f}, {4.6 - 132 * _ls:.3f}) scale({_ls:.6f})">'
